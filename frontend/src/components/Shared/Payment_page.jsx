          ...
          {!paymentSuccess ? (
            <form onSubmit={handleSubmit} className="space-y-4">
              <TextField
                ...
                required
                type="text"
                inputProps={{ pattern: "[0-9 ]{19}", maxLength: 19 }}
              />
              <TextField
                fullWidth
                variant="outlined"
              ...
              <TextField
                ...
                placeholder="123"
                required
                inputProps={{ pattern: "[0-9]{3,4}", maxLength: 3 }}
              />
              <Button
                type="submit"
                color="primary"
            ...
            <>
              ...
              />
              <h2>This is Your Boarding Pass Please Dont Share : 9876543210987 </h2>
            </>
          )}
        </div>
        <div
          className={`w-1/2 h-1/2  rounded-lg shadow-md text-white flex flex-col justify-between`}
        >
